...
public abstract class OSMEntity {
	...
	/**
	 * Constructor for a OSMEntity. Holds the basic information, every
	 * OSM-Object has.
	 *
	 * @param id
	 *            ID
	 * @param version
	 *            Version. Versions &lt;=0 define visible Entities, &gt;0
	 *            deleted Entities.
	 * @param timestamp
	 ...
	 *            UserID
	 * @param tags
	 *            An array of OSHDB key-value ids. The format is
	 *            [KID1,VID1,KID2,VID2...KIDn,VIDn].
	 */
	...
	/**
	 * Tests if any a given key is present but ignores certain values. Useful
	 * when looking for example "TagKey" != "no"
	 *
	 * @param key
	 *            the key to search for
	 * @param uninterestingValues
	 *            list of values, that should return false although the key is
	 *            actually present
