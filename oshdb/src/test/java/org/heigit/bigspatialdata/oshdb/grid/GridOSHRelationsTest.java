...
public class GridOSHRelationsTest {
  ...
  public void test() throws IOException {
    ...
    OSHRelation relation300 = OSHRelationImpl.build(Arrays.asList(//
            new OSMRelation(300, 1, OSHDB.timestamp(3333l), 4444l, 23, new int[]{}, new OSMMember[]{new OSMMember(100, OSMType.NODE, 0, null), new OSMMember(102, OSMType.NODE, 0, null)}), //
            new OSMRelation(300, 2, OSHDB.timestamp(3333l), 4444l, 23, new int[]{1, 2}, new OSMMember[]{new OSMMember(100, OSMType.NODE, 0, null), new OSMMember(102, OSMType.NODE, 0, null)})), //
            Arrays.asList(node100, node102), Arrays.asList());

    OSHRelation relation301 = OSHRelationImpl.build(Arrays.asList(//
            new OSMRelation(301, 1, OSHDB.timestamp(3333l), 4444l, 23, new int[]{}, new OSMMember[]{new OSMMember(200, OSMType.WAY, 1, null), new OSMMember(202, OSMType.WAY, 1, null)}), //
            new OSMRelation(301, 2, OSHDB.timestamp(3333l), 4444l, 23, new int[]{1, 2}, new OSMMember[]{new OSMMember(200, OSMType.WAY, 1, null), new OSMMember(202, OSMType.WAY, 1, null)})), //
