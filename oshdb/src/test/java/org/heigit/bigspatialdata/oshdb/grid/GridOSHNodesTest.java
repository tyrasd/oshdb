  ...
  public void testHOSMCell() {
    ...
    try {
      ...
      for (int i = 0; i < 3; i++) {
        ...
        versions.add(new OSMNode(123l + 10 * i, 1, OSHDB.timestamp(123001l + 10 * i), 0l, 123, new int[] {},
            86809727l - 1000000 * i, 494094984l - 1000000 * i));
        versions.add(new OSMNode(123l + 10 * i, 2, OSHDB.timestamp(123002l + 10 * i), 0l, 123, new int[] {},
            86809727l - 1000000 * i, 494094984l - 1000000 * i));
