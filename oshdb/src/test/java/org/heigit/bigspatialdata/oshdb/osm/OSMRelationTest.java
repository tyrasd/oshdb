...
public class OSMRelationTest {
  ...
  public void testGetMembers() {
    ...
    OSMRelation instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {part, part});
  ...
  public void testCompareTo() {
    ...
    OSMRelation instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {part, part});
    OSMRelation o =
        new OSMRelation(1L, 2, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {part, part});
    assertTrue(instance.compareTo(o) < 0);

    part = new OSMMember(1L, OSMType.WAY, 1);
    instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {part, part});
    o = new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2}, new OSMMember[] {part, part});
    assertTrue(instance.compareTo(o) == 0);
  ...
  public void testHasTagKey() {
    OSMMember part = new OSMMember(1L, OSMType.WAY, 1);
    OSMRelation instance =
        new OSMRelation(1L, 2, OSHDB.timestamp(1L), 1L, 1, new int[] {}, new OSMMember[] {part, part});
    boolean expResult = false;
    boolean result = instance.hasTagKey(1);
    assertEquals(expResult, result);

    part = new OSMMember(1L, OSMType.WAY, 1);
    instance = new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 2, 3, 3},
    ...
    part = new OSMMember(1L, OSMType.WAY, 1);
    instance = new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 2, 2, 2, 3, 3},
        new OSMMember[] {part, part});
    expResult = false;
    ...
    part = new OSMMember(1L, OSMType.WAY, 1);
    instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {2, 1, 3, 3}, new OSMMember[] {part, part});
    expResult = false;
  ...
  public void testHasTagValue() {
    OSMMember part = new OSMMember(1L, OSMType.WAY, 1);
    OSMRelation instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 2, 2, 3}, new OSMMember[] {part, part});
    boolean expResult = false;
  ...
  public void testHasTagValueII() {
    OSMMember part = new OSMMember(1L, OSMType.WAY, 1);
    OSMRelation instance =
        new OSMRelation(1L, 1, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 1, 2, 3}, new OSMMember[] {part, part});
    boolean expResult = true;
    boolean result = instance.hasTagValue(1, 1);
    assertEquals(expResult, result);
  }
  ...
  public void testToString() {
    OSMMember part = new OSMMember(1L, OSMType.WAY, 1);
    OSMRelation instance =
        new OSMRelation(1L, 2, OSHDB.timestamp(1L), 1L, 1, new int[] {1, 2}, new OSMMember[] {part, part});
    String expResult =
