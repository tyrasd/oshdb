...
public class TestOSMContributionGetContributorUserId {
  ...
  private final OSHEntity dummyOshEntity = OSHNodeImpl.build(Collections.singletonList(
      new OSMNode(-1L, 1, OSHDB.timestamp(0L), 1L, 1, new int[]{}, 0, 0)
  ));
  ...
  public void node() throws Exception {
    ...
    OSMContribution c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMNode(1L, 1, OSHDB.timestamp(123L), 1L, 7, new int[]{}, 0, 0), null,
        dummyOshEntity,
        null, null, null, null,
    ...
    c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMNode(1L, 1, OSHDB.timestamp(122L), 1L, 7, new int[] {}, 0, 0), null,
        dummyOshEntity,
        null, null, null, null,
        new LazyEvaluatedContributionTypes(EnumSet.of(ContributionType.CREATION)),
        1L
    ...
    c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMNode(1L, 2, OSHDB.timestamp(122L), 2L, 7, new int[] {3,4}, 0, 0),
        new OSMNode(1L, 1, OSHDB.timestamp(121L), 1L, 6, new int[] {1,2}, 0, 0),
        dummyOshEntity,
        null, null, null, null,
    ...
    c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMNode(1L, -2, OSHDB.timestamp(122L), 2L, 7, new int[] {}, 0, 0), // negative version == isVisible = false
        new OSMNode(1L, 1, OSHDB.timestamp(121L), 1L, 6, new int[] {}, 0, 0),
        dummyOshEntity,
        null, null, null, null,
    ...
    c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMNode(1L, 1, OSHDB.timestamp(122L), 1L, 7, new int[] {}, 0, 0),
        new OSMNode(1L, 1, OSHDB.timestamp(122L), 1L, 7, new int[] {}, 0, 0),
        dummyOshEntity,
        null, null, null, null,
  ...
  public void wayDirect() throws Exception {
    OSMContribution c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMWay(1L, 1, OSHDB.timestamp(123L), 1L, 7, new int[] {}, new OSMMember[] {}), null,
        dummyOshEntity,
        null, null, null, null,
        new LazyEvaluatedContributionTypes(EnumSet.of(ContributionType.CREATION)),
        1L
  ...
  public void wayIndirect() throws Exception {
    ...
    versions.add(new OSMNode(3L, 3, OSHDB.timestamp(125L), 4L, 8, new int[] {}, 0, 0));
    versions.add(new OSMNode(3L, 2, OSHDB.timestamp(123L), 3L, 7, new int[] {}, 0, 0));
    versions.add(new OSMNode(3L, 1, OSHDB.timestamp(121L), 2L, 6, new int[] {}, 0, 0));

    OSMWay entity = new OSMWay(1L, 1, OSHDB.timestamp(122L), 1L, 1, new int[] {}, new OSMMember[] {
  ...
  public void relationDirect() throws Exception {
    OSMContribution c = new OSMContribution(new IterateAllEntry(
        OSHDB.timestamp(123),
        new OSMRelation(1L, 1, OSHDB.timestamp(123L), 1L, 7, new int[] {}, new OSMMember[] {}), null,
        dummyOshEntity,
        null, null, null, null,
        new LazyEvaluatedContributionTypes(EnumSet.of(ContributionType.CREATION)),
        1L
  ...
  public void relationIndirectWay() throws Exception {
    ...
    versions.add(new OSMWay(3L, 3, OSHDB.timestamp(125L), 4L, 8, new int[] {}, new OSMMember[] {}));
    versions.add(new OSMWay(3L, 2, OSHDB.timestamp(123L), 3L, 7, new int[] {}, new OSMMember[] {}));
    versions.add(new OSMWay(3L, 1, OSHDB.timestamp(121L), 2L, 6, new int[] {}, new OSMMember[] {}));

    OSMRelation entity = new OSMRelation(1L, 1, OSHDB.timestamp(122L), 1L, 1, new int[] {}, new OSMMember[] {
  ...
  public void relationIndirectWayNode() throws Exception {
    ...
    nodeVersions.add(new OSMNode(3L, 3, OSHDB.timestamp(125L), 4L, 8, new int[] {}, 0, 0));
    nodeVersions.add(new OSMNode(3L, 2, OSHDB.timestamp(123L), 3L, 7, new int[] {}, 0, 0));
    nodeVersions.add(new OSMNode(3L, 1, OSHDB.timestamp(121L), 2L, 6, new int[] {}, 0, 0));

    List<OSMWay> versions = new ArrayList<>();
    versions.add(new OSMWay(2L, 1, OSHDB.timestamp(120L), 0L, 2, new int[] {}, new OSMMember[] {
        new OSMMember(3, OSMType.NODE, 0, OSHNodeImpl.build(nodeVersions))
    }));

    OSMRelation entity = new OSMRelation(1L, 1, OSHDB.timestamp(110L), 1L, 1, new int[] {}, new OSMMember[] {
